          ...
          <div className="mt-6 flex flex-wrap  justify-between">
            {order?.items?.map((item) => (
              <Link
                ...
                className="rounded-lg w-50 border border-t border-b border-slate-200 bg-beige shadow-sm transition-transform hover:scale-105 hover:border-slate-600 dark:bg-slate-600 dark:hover:border-dslate-400 md:px-0"
              >
