      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ...
            name="search"
            className="block w-full max-w-lg rounded-md border-2 border-slate-300 bg-beige py-2 pl-10 pr-3 text-sm shadow-sm dark:bg-slate-600 dark:shadow-white dark:placeholder:text-slate-200"
