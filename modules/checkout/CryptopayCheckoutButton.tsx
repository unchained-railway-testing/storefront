...
const PayWithCryptoButton = ({ sign }) => (
  <button
    type="button"
    onClick={sign}
    className="mt-6 w-full rounded-md border border-transparent bg-olivebrown-darker py-3 px-4 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-800 focus:ring-offset-2 focus:ring-offset-slate-50"
  >
    Pay with Crypto
  </button>
);
                  ...
                  <div className="bg-beige px-4 pt-5 pb-4 sm:p-10 sm:pb-4">
                    <div className="flex items-center justify-center flex-col">
                      ...
                      <div className="text-center pt-3">
                        ...
                        <span className="font-medium sm:font-normal sm:text-2xl mx-3">
                          {formattedPrice}
                        </span>
                        <span className="my-3">to</span>
                        <div className="font-medium sm:font-normal sm:text-2xl mt-2 break-all px-5">
                          {contractAddress}
                        </div>
                      </div>
                      <div className="relative w-full mt-3">
