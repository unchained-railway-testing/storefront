                  ...
                  <div className="inline-block min-w-full align-middle sm:px-6 lg:px-8">
                    <div className="overflow-hidden border-t border-slate-200 py-8">
                      <Link
                        ...
                        className="inline-flex justify-center rounded-md border border-transparent bg-olivebrown-darker py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:ring-offset-2"
                      >
                        {formatMessage({
                          id: "change_password",
